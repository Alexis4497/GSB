...
namespace GSB
{
    ...
    public partial class GSB_ZinadeEntities : DbContext
    {
        public GSB_ZinadeEntities()
            : base("name=GSB_ZinadeEntities")
        {
        }
        ...
        public virtual DbSet<REMPLACANT> REMPLACANT { get; set; }
